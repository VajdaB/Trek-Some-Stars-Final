/**
 * I STOLE THIS; IT'S NOT MINE, BUT I NEEDED
 * TO MODIFY IT WHICH I COULD NOT DO WITHOUT
 * TAKING IT. THE REAL INFORMATION IS BELOW.
 * QueasyCam
...
if (keys.containsKey(' ') && keys.get(' '))
 velocity.add(PVector.mult(forward, speed*2));
